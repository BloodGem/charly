...
$bloque1 = <<<EOF
    ...
    <table>
        ...
        <tr>
            ...
            <td style="background-color:white; width:575px; text-align:center; color:black"><br><br><br>VENTAS PRODUCTOS POR LINEA</td>
...
<td style="width:55px; text-align:right" font-weight:bold;>Cantidad</td>
<td style="width:55px; text-align:right" font-weight:bold;>Precio U</td>
