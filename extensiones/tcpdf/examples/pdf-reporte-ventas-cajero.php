...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        switch ($no_rango) {
            ...
            break;
                                   ...
                                   $ventas = "Ventas por cajero de ".$traerCajero['nombre'];
    ...
    public function exportarPDFVentasCajero(){
...
<td style="border: 1px solid black; width:125px; text-align:center; font-weight:bold;">Fecha Pago</td>
...
<td style="border: 1px solid black; width:240px; text-align:center; font-weight:bold;">Cliente</td>
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:11px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:125px; text-align:center;">$row[fecha_pago]</td>
            ...
            <td style="border: 1px solid black; width:240px; text-align:center;">$traerCliente[nombre]</td>
...
//$total_utilidad_acumulado = number_format($total_utilidad_acumulado,2);
                    ...
                    $td_texto_total = '<td style="border: 1px solid black; width:400px; text-align:right; font-weight:bold;">TOTAL:</td>';
...
//Close and output PDF document
    ...
    $pdf->Output('ventas por cajero de '.$traerCajero['nombre'].' '.date('d-m-Y').'.pdf', 'D');
...
$ventas_cajero = new MYPDF();
$ventas_cajero -> no_rango = $_GET["no_rango"];
$ventas_cajero -> id_usuario = $_GET["id_usuario"];
$ventas_cajero -> id_sucursal = $_GET["id_sucursal"];
if(isset($_GET['rango_fecha'])){
    $ventas_cajero -> rango_fecha = $_GET['rango_fecha'];
}
$ventas_cajero -> exportarPDFVentasCajero();
