...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        if($tipo == 0){
            $texto_tipo_compra = "N/A ";
        }else if($tipo == 2){
            $texto_tipo_compra = "Resmisión ";
        }
        
        $this->SetY(10);
        $this->SetX(50);
        $this->Cell(0, 15, 'Compras de tipo '.$texto_tipo_compra.$texto, 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->SetY(17);
        $this->SetX(50);
    ...
    public function exportarPDFReporteComprasTipo(){
...
$bloque3 = <<<EOF
    ...
    <table style=style="border: 1px solid black; font-size:12px;">
<tr>
<td style="border: 1px solid black; width:465px; text-align:right; font-weight:bold;">TOTAL</td>
<td style="border: 1px solid black; width:90px; text-align:right; font-weight:bold;">$$total_compras_acumulado</td>
...
// ---------------------------------------------------------
if($tipo == 0){
            $texto_tipo_compra = "NA";
        }else if($tipo == 2){
            $texto_tipo_compra = "Resmisión";
        }
//Close and output PDF document
if($id_sucursal !== "0"){
    $pdf->Output('compras tipo '.$texto_tipo_compra.'.pdf', 'D');
}else{
    $pdf->Output('compras tipo '.$texto_tipo_compra.'.pdf', 'D'); 
}
...
$compras_sucursales -> exportarPDFReporteComprasTipo();
