...
class MYPDF extends TCPDF {
    ...
    $ventas = "Ventas ";
                ...
                if($tipo == "FC"){
                    ...
                    $tipo_venta = "de tipo remisión ";
                }

                $titulo = $ventas.$tipo_venta.$texto;
...
<td style="border: 1px solid black; width:250px; text-align:center; font-weight:bold;">UUID</td>
<td style="border: 1px solid black; width:220px; text-align:center; font-weight:bold;">Cliente</td>
<td style="border: 1px solid black; width:100px; text-align:center; font-weight:bold;">RFC</td>
<td style="border: 1px solid black; width:165px; text-align:center; font-weight:bold;">Vendedor</td>
$td_encabezado
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:11px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:250px; text-align:center;">$row[uuid]</td>

            <td style="border: 1px solid black; width:220px; text-align:center;">
            ...
            <td style="border: 1px solid black; width:165px; text-align:center;">$traerVendedor[nombres]</td>
...
if($id_sucursal !== "0"){
                    $td_texto_total = '<td style="border: 1px solid black; width:165px; text-align:right; font-weight:bold;">TOTALES:</td>';
                }else{
                    $td_texto_total = '<td style="border: 1px solid black; width:165px; text-align:right; font-weight:bold;">TOTALES:</td>';
                }
...
if($id_sucursal !== "0"){
    $pdf->Output('ventas de tipo '.$tipo.'.pdf', 'D');
}else{
    $pdf->Output('ventas de tipo '.$tipo.'.pdf', 'D'); 
}
...
$ventas_sucursales -> exportarPDFVentasTipo();
