...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->SetY(10);
        $this->SetX(50);
        $this->Cell(0, 15, 'DEVOLUCIONES FACTURADAS '.$texto, 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->SetY(17);
        $this->SetX(50);
    ...
    public function exportarPDFDevolucionesTipoFactura(){
...
<tr>
<td style="border: 1px solid black; width:1015px; text-align:center; font-weight:bold;">FACTURADO $row[dia]</td>

</tr>
<tr>
<td style="border: 1px solid black; width:50px; text-align:center;">No.<br>Devol</td>

            <td style="border: 1px solid black; width:50px; text-align:center;">No.<br>Venta</td>

            <td style="border: 1px solid black; width:80px; text-align:center;">Folio</td>

            <td style="border: 1px solid black; width:140px; text-align:center;">Fecha</td>
            
            <td style="border: 1px solid black; width:265px; text-align:center;">UUID</td>

            <td style="border: 1px solid black; width:310px; text-align:center;">Cliente</td>

            <td style="border: 1px solid black; width:120px; text-align:right;">Total</td>
</tr>
</table>
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:13px;">


    
        <tr>
        
            <td style="border: 1px solid black; width:50px; text-align:center;">$row2[id_devolucion]</td>

            <td style="border: 1px solid black; width:50px; text-align:center;">$row2[id_venta]</td>

            <td style="border: 1px solid black; width:80px; text-align:center;">$row2[folio]</td>

            <td style="border: 1px solid black; width:140px; text-align:center;">$row2[fecha_creacion]</td>
            
            <td style="border: 1px solid black; width:265px; text-align:center;">$row2[uuid]</td>

            <td style="border: 1px solid black; width:310px; text-align:center;">$traerCliente[nombre]</td>
...
$bloque3 = <<<EOF
    ...
    <table style=style="border: 1px solid black; font-size:13px;">
<tr>
<td style="border: 1px solid black; width:895px; text-align:right; font-weight:bold;">TOTAL</td>
<td style="border: 1px solid black; width:120px; text-align:right; font-weight:bold;">$$total_devoluciones</td>
...
$devoluciones_sucursales -> tipo = $_GET["tipo"];
$devoluciones_sucursales -> nombre_sucursal = $_GET["nombre_sucursal"];
if(isset($_GET['rango_fecha'])){
    $devoluciones_sucursales -> rango_fecha = $_GET['rango_fecha'];
}
$devoluciones_sucursales -> exportarPDFDevolucionesTipoFactura();
