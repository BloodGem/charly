...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->SetX(50);
        // Title
        $this->Cell(0, 15, "Previa hoja de responsabilidad del inventario no.".$id_inventario , 0, false, 'C', 0, '', 0, false, 'M', 'M');
    ...
    public function exportarPDFPreviaHojaInventario(){
...
$pdf->Output('Previa hoja de responsabilidad del inventario no.'.$id_inventario.' '.date('d-m-Y').'.pdf', 'D');
...
$previa_hoja_inventario = new MYPDF();
$previa_hoja_inventario -> id_inventario = $_GET["id_inventario"];
$previa_hoja_inventario -> exportarPDFPreviaHojaInventario();
