...
class MYPDF extends TCPDF {
    ...
    public function exportarPDFComprasGenerales(){
...
$bloque1 = <<<EOF
    ...
    <table style=style="border: 1px solid black; font-size:14px;">
<tr>
<td style="border: 1px solid black; width:40px; text-align:center; font-weight:bold;">Compra</td>
<td style="border: 1px solid black; width:125px; text-align:center; font-weight:bold;">Fecha</td>
<td style="border: 1px solid black; width:110px; text-align:right; font-weight:bold;">Total</td>
<td style="border: 1px solid black; width:100px; text-align:center; font-weight:bold;">No.Factura</td>
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:12px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:110px; text-align:right;">$$total</td>

            <td style="border: 1px solid black; width:100px; text-align:center;">$row[no_factura]</td>
...
$bloque3 = <<<EOF
    ...
    <table style="font-size:13px;">
        ...
        <td style="border: none; width:165px; text-align:right; font-weight:bold;">TOTAL:</td>

            <td style="border: 1px solid black; width:110px; text-align:right; font-weight:bold;">
...
//Close and output PDF document
    ...
    $pdf->Output('Compras en general '.date('d-m-Y').'.pdf', 'D'); 
...
$compras_generales = new MYPDF();
$compras_generales -> no_rango = $_GET["no_rango"];
if(isset($_GET['rango_fecha'])){
    $compras_generales -> rango_fecha = $_GET['rango_fecha'];
}
$compras_generales -> exportarPDFComprasGenerales();
