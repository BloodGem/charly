...
$nombre_sucursal = $this->nombre_sucursal;
    ...
    $sql = "SELECT * FROM ventas WHERE fecha_creacion BETWEEN '$fecha1' AND '$fecha2' AND ventas.pagada = 1 AND ventas.cancelada = 0".$sql_id_sucursal." ORDER BY ventas.id DESC";
    ...
    $sql = "SELECT * FROM ventas WHERE Date(fecha_creacion) BETWEEN '$fecha1' AND '$fecha2' AND ventas.pagada = 1 AND ventas.cancelada = 0".$sql_id_sucursal." ORDER BY ventas.id DESC";
    break;
    case 3:
...
$bloque1 = <<<EOF
    ...
    <table style=style="border: 1px solid black; font-size:11.5px;">
<tr>
...
<td style="border: 1px solid black; width:115px; text-align:center; font-weight:bold;">Fecha</td>
...
<td style="border: 1px solid black; width:180px; text-align:center; font-weight:bold;">Cliente</td>
<td style="border: 1px solid black; width:180px; text-align:center; font-weight:bold;">Vendedor</td>
$td_encabezado
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:10.5px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:115px; text-align:center">$row[fecha_creacion]</td>
            ...
            <td style="border: 1px solid black; width:180px; text-align:center">$traerVendedor[nombres]</td>
...
if($id_sucursal !== "0"){
                    $td_texto_total = '<td style="border: 1px solid black; width:265px; text-align:right; font-weight:bold;">TOTAL:</td>';
                }else{
                    $td_texto_total = '<td style="border: 1px solid black; width:265px; text-align:right; font-weight:bold;">TOTAL:</td>';
                }
...
if($id_sucursal !== "0"){
    $pdf->Output('ventas de la '.$traerSucursal['nombre'].' '.date('d-m-Y').'.pdf', 'D');
}else{
    $pdf->Output('ventas en general '.date('d-m-Y').'.pdf', 'D'); 
}
