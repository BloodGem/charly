...
class MYPDF extends TCPDF {
    ...
    $devoluciones = "Devoluciones ";
                ...
                if($tipo == "FC"){
                    $tipo_devolucion = "de tipo facturación ";
                }elseif($tipo == "NT"){
                    $tipo_devolucion = "de tipo nota ";
                }elseif($tipo == "RM"){
                    $tipo_devolucion = "de tipo remisión ";
                }

                $titulo = $devoluciones.$tipo_devolucion.$texto;
    ...
    public function exportarPDFDevolucionesTipo(){
...
<tr>
<td style="border: 1px solid black; width:70px; text-align:center;">No.<br>Devol</td>

<td style="border: 1px solid black; width:70px; text-align:center;">No.<br>Venta</td>

<td style="border: 1px solid black; width:70px; text-align:center;">Folio</td>

<td style="border: 1px solid black; width:135px; text-align:center;">Fecha</td>

<td style="border: 1px solid black; width:250px; text-align:center;">Cliente</td>

<td style="border: 1px solid black; width:100px; text-align:right;">Total</td>
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:12px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:70px; text-align:center;">$id_devolucion</td>

            <td style="border: 1px solid black; width:70px; text-align:center;">$row[id_venta]</td>

             <td style="border: 1px solid black; width:70px; text-align:center;">$row[folio]</td>

            <td style="border: 1px solid black; width:135px; text-align:center;">$row[fecha_creacion]</td>

            <td style="border: 1px solid black; width:250px; text-align:center;">$traerCliente[nombre]</td>
...
$total_devoluciones_acumulado = number_format($total_devoluciones_acumulado,2);

if($id_sucursal !== "0"){
                    $td_texto_total = '<td style="border: 1px solid black; width:595px; text-align:right; font-weight:bold;">TOTALES:</td>';
                }else{
                    $td_texto_total = '<td style="border: 1px solid black; width:595px; text-align:right; font-weight:bold;">TOTALES:</td>';
                }
...
$bloque3 = <<<EOF
    ...
    <table style="font-size:12px;">
        ...
        $td_texto_total
            ...
            <td style="border: 1px solid black; width:100px; text-align:right; font-weight:bold;">
            
                $ $total_devoluciones_acumulado
...
if($id_sucursal !== "0"){
    $pdf->Output('devoluciones de tipo '.$tipo.'.pdf', 'D');
}else{
    $pdf->Output('devoluciones de tipo '.$tipo.'.pdf', 'D'); 
}
...
$devoluciones_sucursales -> exportarPDFDevolucionesTipo();
