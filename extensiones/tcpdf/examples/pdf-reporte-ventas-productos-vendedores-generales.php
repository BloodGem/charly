...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        switch ($no_rango) {
            ...
            break;
                                   ...
                                   $devoluciones = "Ventas de Productos por Vendedores en general ";
    ...
    public function exportarPDFVentasProductosVendedores(){
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:12px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:100px; font-weight:bold; text-align:right;">Total Ventas</td>
...
$pdf->writeHTML($bloque3, false, false, false, false, '');
    ...
    $total_ventas_acumulado_productos = number_format($total_ventas_acumulado_productos, 2);
    ...
    <table style="border: none; font-size:12px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:705px; text-align:right; font-weight:bold;">TOTAL VENTAS: $$total_ventas_acumulado_productos</td>
...
/*if($id_vendedor !== "0"){
    ...
    $pdf->Output('Ventas de Productos por Vendedor '.date('d-m-Y').'.pdf', 'D'); 
//}
...
$ventas_productos_vendedores -> exportarPDFVentasProductosVendedores();
