...
class MYPDF extends TCPDF {
    ...
    public function exportarPDFDevolucionesVendedor(){
...
<tr>
<td style="border: 1px solid black; width:40px; text-align:center; font-weight:bold;">Id<br>Devol.</td>
...
<td style="border: 1px solid black; width:40px; text-align:center; font-weight:bold;">Id<br>Venta</td>
<td style="border: 1px solid black; width:60px; text-align:center; font-weight:bold;">Folio</td>
<td style="border: 1px solid black; width:40px; text-align:center; font-weight:bold;">Id<br>Corte<br>Caja</td>
...
foreach ($traerDevoluciones as $key2 => $row) {
    ...
    //$traerVenta = ModeloVentas2::mdlMostrarVenta2($row['id_venta']);
    $total_devolucion = number_format($row['total'], 2);
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:11px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:40px; text-align:center;">$row[id_devolucion]</td>

            <td style="border: 1px solid black; width:125px; text-align:center;">$row[fecha_creacion]</td>

            <td style="border: 1px solid black; width:90px; text-align:right;">$$total_devolucion</td>

            <td style="border: 1px solid black; width:40px; text-align:center;">$row[id_venta]</td>

            <td style="border: 1px solid black; width:60px; text-align:center;">$row[folio]</td>
            
            <td style="border: 1px solid black; width:40px; text-align:center;">$row[id_corte_caja]</td>     
...
$total_devoluciones_acumulado = number_format($total_devoluciones_acumulado,2);
                    $td_texto_total = '<td style="border: 1px solid black; width:165px; text-align:right; font-weight:bold;">TOTAL:</td>';
...
//Close and output PDF document
    ...
    $pdf->Output('Devoluciones del vendedor '.$nombre_usuario.' '.date('d-m-Y').'.pdf', 'D');
...
$devoluciones_vendedor = new MYPDF();
$devoluciones_vendedor -> no_rango = $_GET["no_rango"];
$devoluciones_vendedor -> id_vendedor = $_GET["id_vendedor"];
$devoluciones_vendedor -> id_sucursal = 1;
$devoluciones_vendedor -> nombre_usuario = $_GET["nombre_usuario"];
if(isset($_GET['rango_fecha'])){
    $devoluciones_vendedor -> rango_fecha = $_GET['rango_fecha'];
}
$devoluciones_vendedor -> exportarPDFDevolucionesVendedor();
