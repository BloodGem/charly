...
class MYPDF extends TCPDF {
    ...
    public function exportarPDFVentasVendedores(){
...
$nombre_usuario = $this->nombre_usuario;
    ...
    $sql = "SELECT * FROM ventas WHERE fecha_creacion BETWEEN '$fecha1' AND '$fecha2' AND ventas.pagada = 1 AND ventas.cancelada = 0 AND ventas.id_vendedor = $id_vendedor ORDER BY ventas.id DESC";
    ...
    $sql = "SELECT * FROM ventas WHERE Date(fecha_creacion) BETWEEN '$fecha1' AND '$fecha2' AND ventas.pagada = 1 AND ventas.cancelada = 0 AND ventas.id_vendedor = $id_vendedor ORDER BY ventas.id DESC";
    break;
    case 3:
...
<td style="border: 1px solid black; width:300px; text-align:center; font-weight:bold;">Cliente</td>
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:11px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:300px; text-align:center;">$traerCliente[nombre]</td>
...
//Close and output PDF document
    ...
    $pdf->Output('ventas del vendedor '.$nombre_usuario.' '.date('d-m-Y').'.pdf', 'D');
...
$ventas_vendedor -> id_vendedor = $_GET["id_vendedor"];
$ventas_vendedor -> nombre_usuario = $_GET["nombre_usuario"];
if(isset($_GET['rango_fecha'])){
    $ventas_vendedor -> rango_fecha = $_GET['rango_fecha'];
}
$ventas_vendedor -> exportarPDFVentasVendedores();
