...
class MYPDF extends TCPDF {
    ...
    public function exportarPDFDevolucionesCajero(){
...
foreach ($traerDevoluciones as $key2 => $row) {
    ...
    $total_devolucion = number_format($row['total']);
...
//Close and output PDF document
    ...
    $pdf->Output('Devoluciones del cajero '.$nombre_usuario.' '.date('d-m-Y').'.pdf', 'D');
...
$devoluciones_cajero = new MYPDF();
$devoluciones_cajero -> no_rango = $_GET["no_rango"];
$devoluciones_cajero -> id_usuario = $_GET["id_usuario"];
$devoluciones_cajero -> id_sucursal = 1;
$devoluciones_cajero -> nombre_usuario = $_GET["nombre_usuario"];
if(isset($_GET['rango_fecha'])){
    $devoluciones_cajero -> rango_fecha = $_GET['rango_fecha'];
}
$devoluciones_cajero -> exportarPDFDevolucionesCajero();
