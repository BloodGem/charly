...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        switch ($no_rango) {
            ...
            break;
                                   ...
                                   $devoluciones = "Devoluciones a detalle";
    ...
    public function exportarPDFDevolucionesSucursales(){
...
$nombre_sucursal = $this->nombre_sucursal;
    ...
    $sql = "SELECT devoluciones.*, ventas.id_vendedor AS id_vendedor FROM devoluciones INNER JOIN ventas ON devoluciones.id_venta = ventas.id WHERE devoluciones.fecha_creacion BETWEEN '$fecha1' AND '$fecha2' AND devoluciones.id_sucursal = $id_sucursal ORDER BY devoluciones.id_devolucion DESC";
...
$bloque1 = <<<EOF
    ...
    <table style=style="border: 1px solid black; font-size:9.5px;">
<tr>
<td style="border: 1px solid black; width:45px; text-align:center; font-weight:bold;">IdDevol</td>
<td style="border: 1px solid black; width:60px; text-align:center; font-weight:bold;">Fecha</td>
<td style="border: 1px solid black; width:75px; text-align:right; font-weight:bold;">Importe</td>
<td style="border: 1px solid black; width:130px; text-align:center; font-weight:bold;">Realizo Devolución</td>
<td style="border: 1px solid black; width:130px; text-align:center; font-weight:bold;">Quién Vendio</td>
<td style="border: 1px solid black; width:45px; text-align:center; font-weight:bold;">IdVenta</td>
<td style="border: 1px solid black; width:220px; text-align:center; font-weight:bold;">Motivo Devolución</td>
$td_encabezado
...
while($row = $rs->fetch_array(MYSQLI_BOTH)){
    ...
    $dateFecha = date_create($row['fecha_creacion']);
    $fecha=date_format($dateFecha, 'd-m-Y');

    $partidasDevolucion = ModeloPartdev::mdlMostrarPartidasDevolucion($id_devolucion);
...
$bloque2 = <<<EOF
    ...
    <table style="border: none; font-size:9.5px;">


    
        <tr>
        
            <td style="width:45px; text-align:center;">$id_devolucion</td>

            <td style="width:60px; text-align:center;">$fecha</td>

            <td style="width:75px; text-align:right;">$$total</td>

            <td style="width:130px; text-align:center;">$traerCreador[nombre]</td>

            <td style="width:130px; text-align:center;">$traerVendedor[nombres]</td>

            <td style="width:45px; text-align:center;">$row[id_venta]</td>

            <td style="width:220px; text-align:center;">$traerMotivoDevolucion[motivo_devolucion]</td>
...
$bloque4 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:11px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:70px; text-align:center;">Cantidad<br>Devolución</td>

            <td style="border: 1px solid black; width:100px; text-align:center;">Clave producto</td>
            <td style="border: 1px solid black; width:435px; text-align:center;">Descripción</td>

            <td style="border: 1px solid black; width:100px; text-align:center;">Ubicación</td>
...
$pdf->writeHTML($bloque4, false, false, false, false, '');
    ...
    foreach ($partidasDevolucion as $key => $value) {
    ...
    <table style="border: 1px solid black; font-size:12px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:70px; text-align:center;">$value[cantidad]</td>

            <td style="border: 1px solid black; width:100px; text-align:center;">$traerProducto[clave_producto]</td>
            <td style="border: 1px solid black; width:435px; text-align:center;">$traerProducto[descripcion_corta]</td>

            <td style="border: 1px solid black; width:100px; text-align:center;">$traerProducto[ubicacion]</td>
...
/*if($id_sucursal !== "0"){
    ...
    $pdf->Output('Devoluciones a detalle en general '.date('d-m-Y').'.pdf', 'D'); 
//}
...
$devoluciones_sucursales = new MYPDF();
$devoluciones_sucursales -> no_rango = $_GET["no_rango"];
$devoluciones_sucursales -> id_sucursal = $_GET["id_sucursal"];
if(isset($_GET['rango_fecha'])){
    $devoluciones_sucursales -> rango_fecha = $_GET['rango_fecha'];
}
$devoluciones_sucursales -> exportarPDFDevolucionesSucursales();
