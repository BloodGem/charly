...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->SetY(10);
        $this->SetX(50);
        $this->Cell(0, 15, 'VENTAS FACTURADAS '.$texto, 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->SetY(17);
        $this->SetX(50);
    ...
    public function exportarPDFVentasTipoFactura(){
...
$rs2 = $conexion->query($sql2);
    ...
    $traerCliente = ControladorClientes::ctrMostrarCliente($row2['id_cliente']);
        ...
        $subtotal = number_format(round(($row2['total'] / 1.16), 2), 2);

        $iva = number_format(round($subtotal * 0.16, 2), 2);
...
$bloque2 = <<<EOF
    ...
    <table style="border: 1px solid black; font-size:11px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid black; width:60px; text-align:center">$row2[folio]</td>

            <td style="border: 1px solid black; width:125px; text-align:center">$row2[fecha_creacion]</td>
            
            <td style="border: 1px solid black; width:240px; text-align:center">$row2[uuid]</td>

            <td style="border: 1px solid black; width:180px; text-align:center">$traerCliente[nombre]</td>

            <td style="border: 1px solid black; width:100px; text-align:center">$traerCliente[rfc]</td>

            <td style="border: 1px solid black; width:90px; text-align:right;">$$subtotal</td>
            <td style="border: 1px solid black; width:90px; text-align:right;">$$iva</td>
...
$total_ventas = number_format($row['dia'], 2);
$bloque3 = <<<EOF


    <table style=style="border: 1px solid black; font-size:12px;">
<tr>
<td style="border: 1px solid black; width:875px; text-align:right; font-weight:bold;">TOTAL</td>
<td style="border: 1px solid black; width:140px; text-align:right; font-weight:bold;">$total_ventas</td>
...
$ventas_sucursales -> nombre_sucursal = $_GET["nombre_sucursal"];
if(isset($_GET['rango_fecha'])){
    $ventas_sucursales -> rango_fecha = $_GET['rango_fecha'];
}
$ventas_sucursales -> exportarPDFVentasTipoFactura();
