...
class ModeloPartidasDevoluciones{
	...
	static public function mdlIngresarPartidasDevolucion($datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO partdev (id_devolucion, id_producto, cantidad, precio_unitario, precio_neto, descuento) VALUES (:id_devolucion, :id_producto, :cantidad, :precio_unitario, :precio_neto, :descuento)");
