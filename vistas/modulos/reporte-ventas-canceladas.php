...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Reporte de Ventas Canceladas</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-md-12">
              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                    <button class="btn-sm btn-success btnExportarPDFReporteVentasCanceladas">PDF</button>
                    
                    <button class="btn-sm btn-warning btnExportarEXCELReporteVentasCanceladas">EXCEL</button>
                  </center>
                  </div>
                </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div id="incrustarTablaReporteVentasCanceladas"></div>
              </div>
              <!-- /.card-body -->
            </div>
