...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Reporte de Facturas Globales</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                    <button class="btn-sm btn-success btnExportarPDFReporteFacturasGlobales">PDF</button>
                    
                    <button class="btn-sm btn-warning btnExportarEXCELReporteFacturasGlobales">EXCEL</button>
                  </center>
                  </div>
                </div>
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <div id="incrustarTablaReporteFacturasGlobales"></div>
              </div>
              <!-- /.card-body -->
            </div>
