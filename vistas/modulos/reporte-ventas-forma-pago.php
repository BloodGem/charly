...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Ventas por Forma de Pago</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                    <button class="btn-sm btn-success" id="btnExportarPDFReporteVentasFormaPago">PDF</button>
                    
                    <button class="btn-sm btn-warning" id="btnExportarEXCELReporteVentasFormaPago">EXCEL</button>
                  </div>
                </div>
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body" id="incrustarTablaReporteVentasFormaPago">
