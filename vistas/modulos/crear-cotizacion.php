    ...
    ?>
          ...
          <div class="form-group">
           ...
           <input type="text" class="form-control form-control-sm" style="height:21px; width:100px;"  id="textoPrecio" value="Público" readonly>
                ...
                <input type="hidden" class="form-control form-control-sm" style="height:21px; width:100px;"  id="nuevoDescuentoCotizacion" name="nuevoDescuentoCotizacion" readonly>
            ...
            <div class="card card-primary divBusqueda" style="background-color: #F2D5BB;">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <br>
                  <div class="input-group">
                    <table class="table table-sm table-bordered table-striped listaProductosCotizaciones">
                      <thead>
                        <tr>
                          <th>.</th>
                          <th>Código</th>
          ...
          <div class="col-md-12">
            <form method="post" role="form" id="formularioCotizacion" name="formularioCotizacion" class="formularioCotizacion">
              ...
              <div class="card card-primary divPartidas">
                <div class="card-body">
                    <table class="table table-hover text-nowrap" id="tablaProductosCotizacion" style="font-size:14px;">
          ...
          <input type="hidden" class="form-control" name="listaProductosCotizacion" id="listaProductosCotizacion">

              <input type="hidden" id="nuevoTipoCotizacion" name="nuevoTipoCotizacion" value="NT">
      
              <input type="hidden" class="form-control input-lg" id="nuevoTotalCotizacion" name="nuevoTotalCotizacion" total="" placeholder="00000" tabindex="-1" readonly required>
          ...
          <div class="col-12">
            <center><input type="button" class="btn btn-info" id="btnGenerarCotizacion" value="GENERAR COTIZACION"></center>
          </div>
