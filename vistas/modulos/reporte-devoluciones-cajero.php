  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Devoluciones por Cajer@</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <div class="form-group">
                    <button class="btn-sm btn-success btnExportarPDFReporteDevolucionesCajero">PDF</button>
                    
                    <button class="btn-sm btn-warning btnExportarEXCELReporteDevolucionesCajero">EXCEL</button> 
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body" id="incrustarTablaReporteDevolucionesCajero">
