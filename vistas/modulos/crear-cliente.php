        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="lista-clientes" accesskey="l">Lista de clientes</a></li>
...
<form action="" method="post" id="formularioCrearCliente" name="formularioCrearCliente">
    <!-- Main content -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12"><div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nuevoNombreComercial" name="nuevoNombreComercial" placeholder="" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                </div>
                            </div>
                                <div class="col-lg-3 col-12"><div class="form-group">
                                    <label>Teléfono / Celular
                                    </label>
                                    <input type="number" class="form-control" id="nuevoTelefono1" name="nuevoTelefono1" minlength="10" maxlength="10" placeholder="">
                                </div>
                            </div>
                                <div class="col-lg-3 col-12"><div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-12"><div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="nuevoCodigoPostal" name="nuevoCodigoPostal" placeholder="" minlength="5" maxlength="5" required>
                                </div>
                            </div>
                                <div class="col-lg-3 col-12"><div class="form-group">
                                    <label>Ciudad</label>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-12"><div class="form-group">
                                    ...
                                    <select class="form-control" id="nuevoNoPrecio" name="nuevoNoPrecio">
    ...
    <div class="col-12">
        <center><button type="button" class="btn btn-info" id="btnCrearCliente" name="btnCrearCliente">CREAR CLIENTE</button></center>
    </div>
