...
$traerCajeros = ControladorReportesVentas::ctrSelectCajerosReporteVentasCajero($fecha1, $fecha2, $id_sucursal);
                        ...
                        <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <option value="">--Seleccionar--</option>';
                                    ...
                                    foreach ($traerCajeros as $key => $value) {
                                        echo '<option value="'.$value["id_usuario_creador"].'">'.$value["nombre"].'</option>';
                                    }
