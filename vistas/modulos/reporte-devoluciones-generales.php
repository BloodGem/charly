...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Reporte de Devoluciones Generales</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                    <button class="btn-sm btn-success btnExportarPDFReporteDevolucionesGenerales">PDF</button>
                    
                    <!--<button class="btn-sm btn-warning btnExportarEXCELReporteDevolucionesGenerales">EXCEL</button>-->
                  </center>
                  </div>
                </div>
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <div id="incrustarTablaReporteDevolucionesGenerales"></div>
              </div>
              <!-- /.card-body -->
            </div>
