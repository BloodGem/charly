...
$id_proveedor = $_POST["id_proveedor"];
    ...
    if($crearVistaProductosProveedor == "ok"){
    	...
    	echo '
    	<input type="hidden" id="serversideProductosProveedor2" value="serverside_productos_proveedor_'.$id_sucursal.'_'.$id_usuario.'">
    	<table id="tablaProductosProveedor2" class="table table-striped table-bordered table-condensed" style="width:100%">
