...
$id_marca = $_POST["id_marca"];
    ...
    if($crearVistaProductos == "ok"){
    	...
    	echo '
    	<input type="hidden" id="serversideProductos1" value="serverside_productos_'.$id_sucursal.'_'.$id_usuario.'">
    	<table id="tablaProductos1" class="table table-striped table-bordered table-condensed" style="width:100%">
