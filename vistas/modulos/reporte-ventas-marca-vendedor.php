  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Ventas por Marca por Vendedor</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="card card-warning">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-3 col-12" id="incrustarSelectVendedoresReporteVentasMarcaVendedor">
                ...
                <!--<div class="col-sm-4">
                  <div class="form-group">
                    <label>Cajero</label>
                    <select class="form-control select2" id="id_usuario" name="id_usuario" style="width: 100%;">
                      <option value="">--Selecciona--</option>
                      <?php

                      /*$cajeros = ControladorUsuarios::ctrMostrarVendedores();
                ...
                <div class="col-sm-3">
                  ...
                  <div class="form-group">
                    <button class="btn-sm btn-success" id="btnExportarPDFReporteVentasMarcaVendedor">PDF</button>
                    
                    <button class="btn-sm btn-warning" id="btnExportarEXCELReporteVentasMarcaVendedor">EXCEL</button> 
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body" id="incrustarTablaReporteVentasMarcaVendedor">
