...
switch ($no_rango) {
    ...
    break;
			...
			$Name = 'reporte de devoluciones de productos vendedores generales.xls';
            ...
            foreach ($vendedores as $key => $value) {
                ...
                echo utf8_decode("<table border='0'> 
                   ...
                   <th style='font-weight:bold; border:1px solid #000000;'>Total devoluciones</th>
                   </tr>");
...
foreach ($traerDevolucionesVendedor as $key => $row) {
    ...
    echo'<tr>
    <td style="border:1px solid #9B9B9B;">'.$row['cantidad_devuelta'].'</td> 
    <td style="border:1px solid #9B9B9B;">'.$row['clave_producto'].'</td> 
    <td style="border:1px solid #9B9B9B;">'.$row['descripcion_corta'].'</td>
    <td style="border:1px solid #9B9B9B;">$'.number_format($row['total_devoluciones'], 2).'</td>
    </tr>';
...
<td style="font-weight:bold; border:1px solid #000000;">$'.number_format($total_devoluciones_acumulado_productos, 2).'</td></tr><tr></tr><tr></tr></table>';
