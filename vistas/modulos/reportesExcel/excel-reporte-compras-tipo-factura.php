...
foreach ($traerDiasCompras as $key => $row) {
	...
	echo utf8_decode("<table border='0'> 
					...
					<tr> 
					<th colspan='5' style='font-weight:bold; border:1px solid #000000; background-color: #0087ff;'>FACTURADO ".$row['dia']."</th>
					</tr>
                    <tr> 
    ...
    foreach ($traerCompras as $key2 => $row2) { 
        ...
        $traerProveedor = ControladorProveedores::ctrMostrarProveedor($row2['id_proveedor']);
			 ...
			 echo"<tr>
                        ...
                        <td style='border:1px solid #9B9B9B;'>".$row2['no_factura']."</td>
...
echo '<tr> 
					...
					<th style="font-weight:bold; border:1px solid #000000; text-align: right;">$'.number_format($row['total_compras'], 2).'</th>
					</tr>';
