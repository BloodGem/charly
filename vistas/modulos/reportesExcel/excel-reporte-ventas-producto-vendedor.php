...
$traerVendedores = ControladorVendedores::ctrMostrarVendedores();
			...
			$Name = 'reporte de ventas por marca por vendedor.xls';
...
echo utf8_decode("<table border='0'> 
    ...
    <tr>
                    ...
                    <th colspan='7' style='font-weight:bold; border:1px solid #000000;'>".$rowV['nombres']."</th>
                    </tr>
					<tr>
                    ...
                    <th style='font-weight:bold; border:1px solid #000000;'>Precio</th>
                    <th style='font-weight:bold; border:1px solid #000000;'>Total</th>
					</tr>");

$traerVentasVendedor = ControladorReportesVentas::ctrReporteVentasProductoVendedor($fecha1, $fecha2, $id_producto, $id_vendedor, $id_sucursal);

//echo $traerVentasVendedor;
    ...
    $total_ventas_acumulado = $total_ventas_acumulado + $row['total'];
			...
			echo'<tr>
                ...
                <td style="border:1px solid #9B9B9B;">'.$row['descripcion_corta'].'</td>
			 	<td style="border:1px solid #9B9B9B;">'.number_format($row['cantidad'], 2).'</td>
                <td style="border:1px solid #9B9B9B;">$'.number_format($row['precio_neto'], 2).'</td>
			...
			echo '<tr><td colspan="7" style="font-weight:bold; border:1px solid #EEEEEE; text-align:right;">TOTAL</td>
