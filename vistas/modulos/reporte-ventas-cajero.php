  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Ventas por Cajero</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="card card-warning">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-3 col-12" id="incrustarSelectCajerosReporteVentasCajero">
                ...
                <!--<div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" id="id_usuario" name="id_usuario" style="width: 100%;">
                      ...
                      /*$cajeros = ControladorUsuarios::ctrMostrarCajeros();
                ...
                <div class="col-sm-3">
                  ...
                  <div class="form-group">
                    <button class="btn-sm btn-success" id="btnExportarPDFReporteVentasCajero">PDF</button>
                    
                    <button class="btn-sm btn-warning" id="btnExportarEXCELReporteVentasCajero">EXCEL</button> 
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body" id="incrustarTablaReporteVentasCajero">
