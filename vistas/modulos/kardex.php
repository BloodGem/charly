  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Kardex</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-4 col-12">
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <div class="custom-file">
                              <input type="text" class="form-control" id="buscarProductos" name="buscarProductos" autofocus>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <button class="btn-sm btn-warning btnExportarEXCELReporteEspecificoProductos">EXCEL</button> 
                  </div>
                </div>-->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12" id="incrustarTablaKardex">
                  </div>
