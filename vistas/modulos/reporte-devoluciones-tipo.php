...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 style="font-size: 40px; font-weight: 900;">Devoluciones por Tipo</h1></center>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                    <button class="btn-sm btn-success btnExportarPDFReporteDevolucionesTipo">PDF</button>
                    
                    <button class="btn-sm btn-warning btnExportarEXCELReporteDevolucionesTipo">EXCEL</button> 
                  </div>
                </div>
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body" id="incrustarTablaReporteDevolucionesTipo">
