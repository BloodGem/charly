...
$traerVentasMarcaVendedor = ControladorReportesVentas::ctrReporteVentasMarcaVendedor($fecha1, $fecha2, $id_marca, $id_vendedor, $id_sucursal);

//echo $traerVentasMarcaVendedor;

echo '<table id="tablaReporteVentasMarcaVendedor" class="table table-bordered table-hover">
<thead>
<tr>
...
foreach ($traerVentasMarcaVendedor as $key => $row) {
