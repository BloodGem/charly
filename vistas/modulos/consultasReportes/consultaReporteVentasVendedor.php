...
echo '<table id="tablaReporteVentasVendedor" class="table table-bordered table-hover">
<thead>
<tr>
...
while($row = $rs->fetch_array(MYSQLI_BOTH)){
    ...
    while($row2 = $rs2->fetch_array(MYSQLI_BOTH)){  
        $total_venta = $total_venta + $row2['total_ventas'];
    ...
    $total_utilidad_acumulado = $total_utilidad_acumulado + $utilidad_venta;*/
                        ...
                        //$traerSucursal = ControladorSucursales::ctrMostrarSucursal($row['id_vendedor']);
