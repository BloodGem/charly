...
echo '<table id="tablaReporteDevolucionesVendedor" class="table table-bordered table-hover">
<thead>
<tr>
...
foreach ($traerDevoluciones as $key2 => $row) {
    ...
    /*$traerCreador = ControladorUsuarios::ctrMostrarUsuario($row['id_vendedor_creador']);
