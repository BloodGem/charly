...
switch ($no_rango) {
    ...
    $sql = "SELECT * FROM compras WHERE fecha_creacion BETWEEN '$fecha1' AND '$fecha2' AND compras.estatus <> 0 AND compras.id_sucursal = $id_sucursal AND compras.id_proveedor = $id_proveedor ORDER BY compras.id DESC";
...
echo '<table id="tablaReporteComprasProveedor" class="table table-bordered table-hover">
<thead>
<tr>
...
<th style="text-align: center;">No. Factura</th>
                ...
                <center><h3>Total Compras: $'.number_format($total_ventas_acumulado, 2).'</h3></center>';
