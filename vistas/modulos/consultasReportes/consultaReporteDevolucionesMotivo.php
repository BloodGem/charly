...
$id_motivo_devolucion = $_POST['id_motivo_devolucion'];
...
switch ($no_rango) {
    ...
    $sql = "SELECT * FROM devoluciones WHERE fecha_creacion BETWEEN '$fecha1' AND '$fecha2' AND devoluciones.id_motivo_devolucion = $id_motivo_devolucion AND devoluciones.id_sucursal = $id_sucursal ORDER BY devoluciones.id_devolucion DESC";
...
echo '<table id="tablaReporteDevolucionesMotivo" class="table table-bordered table-hover">
<thead>
<tr>
