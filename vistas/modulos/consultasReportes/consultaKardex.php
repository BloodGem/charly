...
while($row = $rs->fetch_array(MYSQLI_BOTH)){
    ...
    echo '<tr>
    <td style="text-align: center;">'.$row["mo_fecha"].'</td>
    <td style="text-align: center;">'.$row["mo_tipo"].'</td>
    <td style="text-align: center;">'.$row["mo_refer"].'</td>
    <td style="text-align: center;">'.$traerProducto["descripcion_corta"].'</td>
    <td style="text-align: right;">'.$row["mo_cant"].'</td>
    <td style="text-align: right;">'.$row["mo_existencias"].'</td>
    <td style="text-align: center;">'.$row["mo_entsal"].'</td>
    </tr>';
}
