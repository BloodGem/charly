...
$('#no_rango').on('change', function() {
  ...
  document.getElementById("incrustarRangoFechaReporteVentasTipo").innerHTML = "";
  if(no_rango == 9){
...
/*=============================================
        ...
        $(document).on("click", ".btnExportarPDFReporteVentasTipo", function(){
                ...
                window.open("extensiones/tcpdf/examples/ventas-tipo.php?tipo="+tipo+"&no_rango="+no_rango+"&rango_fecha="+rango_fecha+"&id_sucursal="+id_sucursal+"&nombre_sucursal="+nombre_sucursal, "_blank");
              }
        });
        ...
        $(document).on("click", ".btnExportarEXCELReporteVentasTipo", function(){
                ...
                if(tipo == "" || no_rango == "" || id_sucursal == ""){
                  ...
                  window.open("vistas/modulos/reportesExcel/ventas-tipo.php?tipo="+tipo+"&no_rango="+no_rango+"&rango_fecha="+rango_fecha+"&id_sucursal="+id_sucursal, "_blank");
