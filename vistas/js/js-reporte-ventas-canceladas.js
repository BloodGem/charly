...
$('#no_rango').on('change', function() {
  ...
  if(no_rango !== "" && id_sucursal !== ""){
    document.getElementById("incrustarTablaReporteVentasCanceladas").innerHTML = '<center><img class="cargando" src="vistas/img/plantilla/cargando2.gif" alt="Cargando..."></center>';
  }
...
/*=============================================
        ...
        $(document).on("click", ".btnExportarPDFReporteVentasCanceladas", function(){
                ...
                window.open("extensiones/tcpdf/examples/pdf-reporte-ventas-canceladas.php?no_rango="+no_rango+"&rango_fecha="+rango_fecha+"&id_sucursal="+id_sucursal+"&nombre_sucursal="+nombre_sucursal, "_blank");
              }
        });
        ...
        $(document).on("click", ".btnExportarEXCELReporteVentasCanceladas", function(){
                ...
                window.open("vistas/modulos/reportesExcel/excel-reporte-ventas-canceladas.php?no_rango="+no_rango+"&rango_fecha="+rango_fecha+"&id_sucursal="+id_sucursal+"&nombre_sucursal="+nombre_sucursal, "_blank");
